...
/* Dark values are re-picked rather than inverted: the marigold and peacock
   are lightened so they still carry against a dark ground, and the navy
   deepens instead of flipping to pure black. */
